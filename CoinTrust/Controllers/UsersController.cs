...
namespace CoinTrust.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "email,password,phone,certification,use_phone_authenticator,use_google_authenticator,create_at,update_at")] User user)
        {
            if (ModelState.IsValid)
            {
